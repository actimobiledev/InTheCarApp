...
import com.inthecarapp.app.AppController;
...
// Create a calendar object that will convert the date and time value in milliseconds to date.
    ...
    public static void showSnackBar(Activity activity, View view, String message, int duration, String button_text, View.OnClickListener onClickListener) {
        ...
        sbView.setBackgroundColor(activity.getResources().getColor(R.color.pressed_color));
...
//            c.startActivity (icc);
    ...
    public static boolean sendMail(Context c) {
        final String mail = "info@primalmetrics.com";//c.getString (R.string.intent_mail);
