   ...
   public static VolleyApi getInstance(Activity activity){
    ...
    public void hitApiPostwithBody (final Activity activity, final CallBacks callBacks, final String url, final Map<String, String> parameters, final int requestCode, final String body) {
        ...
        if (NetworkConnection.isNetworkAvailable (activity)) {
          //  Utils.showProgressDialog (activity_new_login, progressDialog, activity_new_login.getResources ().getString (R.string.progress_dialog_text_please_wait), true);
                            ...
                            if (response != null) {
                                try {
                                  ...
                                  //  progressDialog.dismiss ();
                                   ...
                                   // progressDialog.dismiss ();
                                   // Utils.showSnackBar (activity_new_login, clMain, activity_new_login.getResources ().getString (R.string.snackbar_text_exception_occurred), Snackbar.LENGTH_LONG, getResources ().getString (R.string.snackbar_action_dismiss), null);
                                    e.printStackTrace ();
                                }
                            } else {
                              //  progressDialog.dismiss ();
